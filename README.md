...
Current baseline AUC: **0.8521 on ml-25m at SEED=42** (5-seed mean 0.8513) with `EVAL_DYNAMIC_HIST=1 FREQ_WD_LAMBDA=0` (apr28ag, post-apr28ad-arc). Static-history baseline: 0.8282 (deterministic, SEED=42; 5-seed mean +0.00175 over the prior 0.8263 LR/WD-retuned baseline). Reached by stacking three individually sub-threshold mechanisms — each +0.0005 to +0.0007 single-seed alone, but +0.0017 multi-seed when combined (super-additive).
