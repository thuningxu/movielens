...
graph TD
    ...
    subgraph "Training"
        ...
        LOSS --> OPT["Adam, LR=7e-5<br/>weight_decay=1e-4<br/>AMP fp16, grad accum 2×<br/>batch=16384, eff. 33K<br/>NEG_RATIO=1, TRAIN_NEG_MODE=anchor_pos_catalog<br/>patience=3, eval 3×/epoch"]
    end
